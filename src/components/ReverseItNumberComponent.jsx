...
const ReverseItNumberComponent = () => {
  ...
  return (
    <div className="bg-[url(/src/assets/backgrounds/siddhesh-mangela-xXh8AgA2Bfo-unsplash.jpg)] h-[100vh] bg-cover">
      ...
      <input id="reverseNumInput" type="text" onChange={(event) => setReverseNumInput(event.target.value)} placeholder="number..." className="rounded-md w-[20rem] mt-[8rem] ml-[39rem]" />
