...
const AddTwoNumbersComponent = () => {
  ...
  return (
    <div className='bg-[url(/src/assets/backgrounds/annie-spratt-r_m-JKJVto0-unsplash.jpg)] lg:h-[100vh] lg:w-[220.9vh] md:h-[107vh] md:w-[80vh] max-sm:h-[100vh] max-sm:w-[46.5vh] bg-cover'>
      ...
      <input id="num1Input" type="number" onChange={(event) => setNumber1(event.target.value)} placeholder="number1..." className="rounded-md lg:w-[20rem] lg:mt-[8rem] lg:ml-[20rem] md:ml-[5rem] md:mt-[40rem] md:w-[40rem] max-sm:ml-[5rem] max-sm:mt-[40rem] max-sm:w-[20rem]" />
      <br />
      <input id="num2Input" type="number" onChange={(event) => setNumber2(event.target.value)} placeholder="number2..." className="rounded-md lg:w-[20rem] mt-[1rem] lg:ml-[20rem] md:ml-[5rem] md:w-[40rem] max-sm:ml-[5rem] max-sm:mt-[1rem] max-sm:w-[20rem]" />
      <br />
